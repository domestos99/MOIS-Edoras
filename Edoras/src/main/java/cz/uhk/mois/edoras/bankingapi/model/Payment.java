...
public class Payment
{
     ...
     */
    @JsonAdapter(RealizationStatusEnum.Adapter.class)
    public enum RealizationStatusEnum
    {
        ...
        public static class Adapter extends TypeAdapter<RealizationStatusEnum>
        {
            @Override
            public void write(final JsonWriter jsonWriter, final RealizationStatusEnum enumeration) throws IOException
            {
                jsonWriter.value(enumeration.getValue());
            }

            @Override
            public RealizationStatusEnum read(final JsonReader jsonReader) throws IOException
            {
                String value = jsonReader.nextString();
                return RealizationStatusEnum.fromValue(String.valueOf(value));
            }
        }
    }

    @SerializedName("realizationStatus")
